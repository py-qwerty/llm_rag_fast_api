...
$JWT_SIGNATURE = $envVars.JWT_SIGNATURE
...
gcloud run deploy $SERVICE_NAME `
  ...
  --cpu 1 `
  --max-instances 10 `
  --set-env-vars "OPENAI_API_KEY=$OPENAI_API_KEY,JWT_SIGNATURE=$JWT_SIGNATURE,DEFAULT_EMBEDDING_MODEL=$DEFAULT_EMBEDDING_MODEL,EXPECTED_DIMENSIONS=$EXPECTED_DIMENSIONS,HOST=$APP_HOST,LOG_LEVEL=$LOG_LEVEL,CACHE_SIZE=$CACHE_SIZE,TIMEOUT_SECONDS=$TIMEOUT_SECONDS"
